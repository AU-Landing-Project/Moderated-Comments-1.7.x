...
<div
	...
	<?php echo elgg_view("output/longtext",array("value" => $vars['annotation']->value)); ?>
		...
		if($can_see_unapproved && !$reviewed){
			...
			echo "<br><br>";
			echo "<a href=\"" . $vars['url'] . "mod/moderated_comments/actions/annotation/review.php?id=" . $vars['annotation']->id . "&action=approve\">Approve</a>";
			echo "&nbsp;&nbsp;|&nbsp;&nbsp;";
			echo "<a href=\"" . $vars['url'] . "mod/moderated_comments/actions/annotation/review.php?id=" . $vars['annotation']->id . "&action=delete\" onclick=\"return confirm('". elgg_echo('moderated_comments:delete_confirm') . "')\";>Delete</a>";
			echo "</td></tr></table>";
			echo "</div>";
		}
